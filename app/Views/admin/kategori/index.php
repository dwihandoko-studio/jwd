            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <button type="button" onclick="actionAdd(this)" class="btn btn-sm btn-neutral">Tambah Kategori</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#contentModalLabel').html('EDIT KATEGORI');
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#contentModalLabel').html('TAMBAH KATEGORI');
                    $('.contentBodyModal').html(resul.data);
                    $('#contentModal').modal({
                        backdrop: 'static',
                        keyboard: false
    ...
    $(document).ready(function() {
        ...
        let tableUsulan = $('#data-table-id').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('admin/kategori/getAll') ?>",
                "type": "POST",
