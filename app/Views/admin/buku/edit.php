                        ...
                        <form id="formAddData" class="form-horizontal form-add-data" method="post">
                                            ...
                                            <?php if (isset($kategoris)) {
                                                if (count($kategoris) > 0) {
                                                    foreach ($kategoris as $key => $val) { ?>
                                                        <option value="<?= $val->kid ?>" <?= $val->kid == $data->k_id ? " selected" : "" ?>><?= $val->kategori ?></option>
                                            <?php }
                                                }
                                            } ?>
                                        </select>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group _nama_buku-block">
                                        ...
                                        <input type="text" class="form-control nama-buku" id="_nama_buku" value="<?= $data->nama_buku ?>" name="_nama_buku" placeholder="Nama buku . . ." onFocus="inputFocus(this);" required />
                                        <div class="help-block _nama_buku"></div>
                                        <input type="hidden" id="_id" value="<?= $data->bid ?>" name="_id" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group _pengarang-block">
                                        <label for="_pengarang" class="form-control-label">Pengarang</label>
                                        <input type="text" class="form-control pengarang" id="_pengarang" name="_pengarang" value="<?= $data->pengarang ?>" placeholder="Pengarang . . ." onFocus="inputFocus(this);" required />
                            ...
                            <div class="row col-md-12">
                                    ...
                                    <div class="form-group _tahun-block">
                                        ...
                                        <select class="form-control tahun" name="_tahun" id="_tahun" data-toggle="select-2" title="Simple select" data-live-search="true" data-live-search-placeholder="Search ..." required>
                                            ...
                                            <?php for ($i = 1945; $i < 2030; $i++) {  ?>
                                                <option value="<?= $i ?>" <?= $i == (int)$data->tahun_terbit ? " selected" : "" ?>>Tahun <?= $i ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group _harga-block">
                                        ...
                                        <input type="number" class="form-control harga" id="_harga" name="_harga" value="<?= $data->harga ?>" placeholder="Harga . . ." onFocus="inputFocus(this);" required />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group _quantiti-block">
                                        ...
                                        <input type="number" class="form-control quantiti" id="_quantiti" name="_quantiti" value="<?= $data->stok ?>" placeholder="Harga . . ." onFocus="inputFocus(this);" required />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group _deskripsi-block">
                                    <textarea class="form-control deskripsi" id="_deskripsi" name="_deskripsi" rows="5" onFocus="inputFocus(this);" placeholder="Deskripsi . . ." required><?= $data->deskripsi ?></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="preview-image-upload">
                                            <?php if ($data->gambar !== null) { ?>
                                                <img src="<?= base_url('uploads/buku') . '/' . $data->gambar ?>" alt="place" class="imagePreviewUpload" id="imagePreviewUpload" />
                                            <?php } else { ?>
...
<script>
    ...
    function addSave(event) {
        ...
        $.ajax({
            ...
            url: "<?= base_url('admin/buku/editSave') ?>",
            type: 'POST',
            data: formUpload,
            contentType: false,
            cache: false,
