        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <div class="alert alert-default bg-gradient-white alert-dismissible fade show" role="alert">
                    ...
                    <span class="alert-text" style="color: #32325d !important;"><strong>Selamat Datang <?= $user->fullname ?>!</strong><br> Di Toko Buku KNTechline.</span>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Pengguna</h5><span class="h2 font-weight-bold mb-0">0</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Buku</h5><span class="h2 font-weight-bold mb-0">0</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Orderan</h5><span class="h2 font-weight-bold mb-0">0</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Pesan Masuk</h5><span class="h2 font-weight-bold mb-0">0</span>
                                    </div>
                                    <div class="col-auto">
