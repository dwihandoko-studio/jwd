<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#bukuMenu" class="nav-link <?= isset($bukuMenu) ? "active" : "" ?>" aria-controls="bukuMenu" role="button" aria-expanded="<?= isset($bukuMenu) ? "false" : "true" ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse  <?= isset($bukuMenu) ? "show" : "" ?>" id="bukuMenu">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item <?= isset($bukuMenuKategori) ? "active" : "" ?>">
                            <a class="nav-link <?= isset($bukuMenuKategori) ? "active" : "" ?>" href="<?= base_url('admin/kategori') ?>">
                                <span class="sidenav-mini-icon"> K </span>
                                <span class="sidenav-normal"> Kategori Buku </span>
                            </a>
                        </li>
                        <li class="nav-item <?= isset($bukuMenuBuku) ? "active" : "" ?>">
                            <a class="nav-link <?= isset($bukuMenuBuku) ? "active" : "" ?>" data-bs-toggle="collapse" aria-expanded="<?= isset($bukuMenuBuku) ? "false" : "" ?>" href="#menuDataBuku">
                                <span class="sidenav-mini-icon"> B </span>
                                <span class="sidenav-normal"> Buku <b class="caret"></b></span>
                            </a>
                            <div class="collapse <?= isset($bukuMenuBuku) ? "show" : "" ?>" id="menuDataBuku">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item <?= isset($bukuMenuBukuAdd) ? "active" : "" ?>">
                                        <a class="nav-link <?= isset($bukuMenuBukuAdd) ? "active" : "" ?>" href="<?= base_url('admin/buku/add') ?>">
                                            <span class="sidenav-mini-icon text-xs"> T </span>
                                            <span class="sidenav-normal"> Tambah Buku </span>
                                        </a>
                                    </li>
                                    <li class="nav-item <?= isset($bukuMenuBukuData) ? "active" : "" ?>">
                                        <a class="nav-link <?= isset($bukuMenuBukuData) ? "active" : "" ?>" href="<?= base_url('admin/buku') ?>">
            ...
            <li class="nav-item">
                <a href="<?= base_url('admin/orderan') ?>" class="nav-link ">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#menuPesan" class="nav-link " aria-controls="menuPesan" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="menuPesan">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="<?= base_url('admin/message/new') ?>">
                                <span class="sidenav-mini-icon"> PB </span>
                                <span class="sidenav-normal"> Pesan Baru </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="<?= base_url('admin/message/old') ?>">
                                <span class="sidenav-mini-icon"> PL </span>
                                <span class="sidenav-normal"> Pesan Lama </span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#menuPengguna" class="nav-link " aria-controls="menuPengguna" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="menuPengguna">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="<?= base_url('admin/pengguna/new') ?>">
                                <span class="sidenav-mini-icon"> PB </span>
                                <span class="sidenav-normal"> Pengguna Baru </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="<?= base_url('admin/pengguna') ?>">
                                <span class="sidenav-mini-icon"> SP </span>
                                <span class="sidenav-normal"> Semua Pengguna </span>
                            </a>
                        </li>
                    </ul>
                </div>
